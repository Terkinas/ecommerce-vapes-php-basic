<form action="{{ route('info.cookieagreement') }}" method="post" class="fixed left-0 right-0 bottom-0 z-40">
    ...
    <div class="pt-8 pb-3 bg-gray-50 border-gray-100 border-t-1">
        <div class="container px-4 mx-auto">
            ...
            <div class="text-center"><button type="submit" class="inline-block w-full sm:w-auto px-7 py-4 mb-3 sm:mb-0 sm:mr-5 text-center font-medium bg-green-500 hover:bg-green-600 text-white rounded transition duration-250">Accept All Cookies</button><a class="inline-block w-full sm:w-auto px-7 py-2 text-center font-medium border border-white text-gray-400 hover:border-gray-200 hover:text-gray-200 rounded" href="#">Read More</a></div>
        </div>
    </div>
</form>