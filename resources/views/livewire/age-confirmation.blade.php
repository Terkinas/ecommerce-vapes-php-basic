            ...
            <form action="{{ route('info.ageconfirm') }}" method="post" class="relative bg-white rounded-lg shadow dark:bg-gray-700 top-1/3">
                ...
                <div class="p-6 text-center">
                    ...
                    <div class="w-full flex justify-between flex-nowrap">
                        <button data-modal-toggle="popup-modal" type="submit" class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-semibold rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            Yes, I'm over 18 of age
                        </button>
                        <button data-modal-toggle="popup-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">I'm under 18</button>
                    </div>
                </div>
            </form>
        </div>
