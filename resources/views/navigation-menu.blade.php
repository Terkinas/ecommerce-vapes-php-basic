...
<div class="z-49">
    <div class="w-full bg-gray-100 py-2 text-center">
        <h2 class="text-red-500 font-bold text-xs md:text-base scale-75 whitespace-nowrap">Warning: The products contain Nicotine. Nicotine is an addictive chemical.</h2>
